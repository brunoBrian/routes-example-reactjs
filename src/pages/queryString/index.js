  ...
  return (
    <div>
      <div>
        ...
        <ul>
          <li>
            <Link to={`${pathname}/account?name=netflix`}>Netflix</Link>
          </li>
          <li>
            <Link to={`${pathname}/account?name=zillow-group`}>Zillow Group</Link>
          </li>
          <li>
            <Link to={`${pathname}/account?name=yahoo`}>Yahoo</Link>
          </li>
          <li>
            <Link to={`${pathname}/account?name=modus-create`}>Modus Create</Link>
          </li>
        </ul>
